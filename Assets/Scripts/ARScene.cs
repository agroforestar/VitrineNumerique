...
public class ARScene : MonoBehaviour
{
   ...
   public GameObject stars;
    ...
    private void Update()
    {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        GameObject[] gameObjectsWithTag = GameObject.FindGameObjectsWithTag("treeClone");
        if (gameObjectsWithTag.Length > 0)
        {
            if(sliderGrow.value == 0)
            {
                float growthScale = 6f;
                foreach (GameObject obj in gameObjectsWithTag)
                {
                    obj.transform.localScale = new Vector3(growthScale, growthScale, growthScale);
                }

            }
            else
            {
                float growthScale = sliderGrow.value + 6f;
                foreach (GameObject obj in gameObjectsWithTag)
                {
                    obj.transform.localScale = new Vector3(growthScale, growthScale, growthScale);
                }
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        GameObject[] gameObjectsWithTagHaie = GameObject.FindGameObjectsWithTag("haieClone");
        if (gameObjectsWithTagHaie.Length > 0)
        {
            if(sliderGrow.value == 0)
            {
                float growthScale = 1.5f;
                foreach (GameObject obj in gameObjectsWithTagHaie)
                {
                    obj.transform.localScale = new Vector3(growthScale, growthScale, growthScale);
                }
            ...
            {
                float growthScale = sliderGrow.value + 1.5f;
                foreach (GameObject obj in gameObjectsWithTagHaie)
                {
                    obj.transform.localScale = new Vector3(growthScale, growthScale, growthScale);
                }
